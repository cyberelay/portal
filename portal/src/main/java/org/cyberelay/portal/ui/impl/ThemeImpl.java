 ...
 * 
 */
public class ThemeImpl extends AbstractUIComponent implements Theme {
	private UIPane rootPane;
	
	public ThemeImpl(Template template) {
		super(template);
	}

	public UIPane getRootPane() {
		return rootPane;
	}
	
	public void setRootPane(UIPane rootPane) {
