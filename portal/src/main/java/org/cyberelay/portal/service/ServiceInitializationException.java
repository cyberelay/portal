 ...
 * 
 */
public class ServiceInitializationException extends PortalException {
	 ...
	 * @param e
	 */
	public ServiceInitializationException(Throwable e) {
		super(e);
	}
	 ...
	 * @param e
	 */
	public ServiceInitializationException(String message, Throwable e) {
		super(message, e);
	}
