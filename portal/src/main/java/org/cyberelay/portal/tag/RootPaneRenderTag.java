 ...
 * <li>Last Update Time: $Date: 2008-03-14 23:06:57 +0800 (Fri, 14 Mar 2008) $
 * </ul>
 * 
 */
public class RootPaneRenderTag extends UIComponentRenderTag {

	private static final long serialVersionUID = 7814912801179274998L;

	protected UIComponent getComponent() {
		Theme theme = (Theme) getRenderingUIComponent();
		return theme.getRootPane();
	}
