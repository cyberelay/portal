...
public interface BranchOutNode extends RequestProcessNode {
	...
	/**
	 * check if the request processing should go branch process chain
	 * 
	 * @param request
	 * @param response
	 * @return
	 */
	boolean isBranchOutRequired(HttpServletRequest request, HttpServletResponse response);
	
	/**
	 * Retrieve the branch process chain
	 * 
	 * @return
	 */
	RequestProcessChain getBranch();
}
