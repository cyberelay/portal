 ...
 *
 */
class PortletTitleListenerInvoker extends PortletInvoker {
	...
	protected void invokeMethod(PortletMethod method, PortletWindowEx window,
		...
		if (portlet instanceof PortletTitleListener) {
            ((PortletTitleListener)portlet).doTitle(portletRequest, portletResponse);
		}
	}
