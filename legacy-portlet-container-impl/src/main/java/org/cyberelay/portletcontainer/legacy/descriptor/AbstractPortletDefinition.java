 ...
 * 
 */
public interface AbstractPortletDefinition {

    String getUniqueName();

    Class<Portlet> getPortletClass();
    
    String getPortletClassName();
    
    String getAbstractPortetApplicationName();
    
    String getParameter(String name);
    
    /**
     * Retrieve an immutable map.
     * 
     * @return
     */
    Map<String, String> getParameters();
    
    State[] getAllowedWindowStates();
    
    Mode[] getSupportedPortletModes(Client client);
    
    String[] getSupportedMarkups();
    
    Mode[] getSupportedModes(String markup);
    
    boolean isStateAllowed(State state);
    
    boolean isModeSupported(Client client, Mode mode);
}
