 ...
 * 
 */
@ServiceTag(defaultImpl="org.cyberelay.portletcontainer.legacy.service.impl.DefaultPortletDataServiceImpl")
public interface PortletDataService extends PortletContainerService {

    PortletData getPortletData(User user, PortletWindowEx window);
}
