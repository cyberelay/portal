 ...
 * 
 */
public interface PortletNavigationStateService extends PortletContainerService {

	State getWindowState(HttpServletRequest request, PortletWindowEx window);

	void setWindowState(HttpServletRequest request, PortletWindowEx window, State state)
			throws AccessDeniedException;

	Mode getMode(HttpServletRequest request, PortletWindowEx window);

	Mode getPreviousMode(HttpServletRequest request, PortletWindowEx window);

	void setModeModifier(HttpServletRequest request, PortletWindowEx window, ModeModifier modifier)
			throws AccessDeniedException;
