 ...
 * 
 */
public class ListenerInstantiationException extends PortletException {
	 ...
	 * @param text
	 */
	public ListenerInstantiationException(String text) {
		super(text);
		// TODO Auto-generated constructor stub
	}
	 ...
	 * @param cause
	 */
	public ListenerInstantiationException(String text, Throwable cause) {
		super(text, cause);
		// TODO Auto-generated constructor stub
	}
