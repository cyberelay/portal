 ...
 * 
 */
class LegacyPageLoginNode extends GenericProcessNode {

	public void process(HttpServletRequest req, HttpServletResponse res)
			throws ServletException, IOException {
		PageDefinition page = getRequestingPage(req);

		if (isFirstTimeRequest(req, page)) {
			// TODO;
		}
	...
	private boolean isFirstTimeRequest(HttpServletRequest req, PageDefinition page) {
