 ...
 * 
 */
class LegacyRenderPhaseProcessNode extends GenericProcessNode {

	private static final Logger LOG = LoggerFactory.getLogger(LegacyRenderPhaseProcessNode.class);
